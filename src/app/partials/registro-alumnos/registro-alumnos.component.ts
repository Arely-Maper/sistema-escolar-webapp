...
export class RegistroAlumnosComponent implements OnInit{
  ...
  //Constructores para activar el envio en el formulario
  constructor(
  ...
  ngOnInit(): void {
    ...
    //Realiza los cambios en el formulario para ocultar los campos de contraseña y bloquea la edición de correo
